...
def crop(cropped):
	...
	test_image = project_path + "/images/utm_amsterdam.png"
...
def cropResultingPath(coordinates):
	real = toFloatCoordinate([coordinates[0], coordinates[2]])	
	p = pyproj.Proj(proj='utm', zone=31, ellps='WGS84')
	
	cropped = []
	locate = [[0,0],[0,0]]
	for coordinate in real:
